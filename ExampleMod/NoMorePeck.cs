...
public class NoMorePeck : Mod
{
    ...
    {
        var harmony_Marsh_NoMorePeck_1_1 = HarmonyInstance.Create("com.raft.marshmello.nomorepeck");
        harmony_Marsh_NoMorePeck_1_1.PatchAll(Assembly.GetExecutingAssembly());
    }
}